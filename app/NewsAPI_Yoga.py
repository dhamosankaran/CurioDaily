...
class YogaNewsFetcher:
    def __init__(self):
        ...
        self.preferred_entities = [
            'Yoga Journal', 'Yoga Alliance', 'Iyengar Yoga', 'Ashtanga Yoga', 'Bikram Yoga',
            'Kundalini Yoga', 'Hatha Yoga', 'Vinyasa Yoga', 'Yin Yoga', 'Restorative Yoga',
            'International Yoga Day', 'Yoga Therapy', 'Yoga Science', 'Yoga Research'
        ]
        self.db_url = os.getenv('DATABASE_URL')
        if not self.db_url:
            raise ValueError("DATABASE_URL not found in environment variables")

        # List of trusted yoga news sources
        self.trusted_sources = [
            'yogajournal.com', 'gaia.com', 'doyogawithme.com', 'yogainternational.com',
            'yogaalliance.org', 'mindbodygreen.com', 'elephantjournal.com', 'yogitimes.com',
            'yogabasics.com', 'yogicwayoflife.com', 'artofliving.org', 'yogaoutlet.com',
            'yogaanonymous.com', 'doyouyoga.com', 'yogapedia.com', 'yogadigest.com',
            'yogauonline.com', 'yogicfoods.com', 'yogalifestyle.com', 'yogamagazine.com'
        ]

        self.focus_areas = [
            # Yoga Styles
            'Hatha Yoga', 'Vinyasa Yoga', 'Ashtanga Yoga', 'Iyengar Yoga', 'Kundalini Yoga',
            'Bikram Yoga', 'Yin Yoga', 'Restorative Yoga', 'Power Yoga', 'Gentle Yoga',

            # Yoga Philosophy and History
            'Yoga Sutras', 'Bhagavad Gita', 'Yoga Philosophy', 'History of Yoga',
            'Yoga Ethics', 'Yoga Lifestyle',

            # Yoga Practice
            'Asanas', 'Pranayama', 'Meditation', 'Yoga Nidra', 'Yoga for Beginners',
            'Advanced Yoga Practices', 'Yoga Sequencing', 'Yoga Alignment',

            # Yoga and Health
            'Yoga Therapy', 'Yoga for Stress Relief', 'Yoga for Flexibility',
            'Yoga for Strength', 'Yoga for Back Pain', 'Yoga for Mental Health',
            'Yoga and Mindfulness', 'Yoga for Weight Loss',

            # Yoga Community and Events
            'Yoga Retreats', 'Yoga Workshops', 'Yoga Teacher Training',
            'Online Yoga Classes', 'Yoga Festivals', 'International Yoga Day',

            # Yoga Lifestyle
            'Yoga Nutrition', 'Ayurveda', 'Yoga Clothing', 'Yoga Accessories',
            'Sustainable Yoga Practice', 'Yoga and Environmentalism',

            # Yoga Research and Science
            'Yoga Research', 'Scientific Studies on Yoga', 'Yoga and Neuroscience',
            'Yoga and Physical Therapy', 'Yoga in Healthcare'
        ]
    ...
    def fetch_news(self, keywords, date, language='en', sort_by='relevancy'):
        ...
        try:
            ...
            logger.info(f"articles: {response}")
    ...
    def generate_dynamic_title(self, highlights):
        ...
        be engaging and specific to yoga advancements mentioned in the highlights.

        Highlights:
        {highlights}

        Generate a title in the format: "Yoga [Theme]: [Specific Detail]"
        For example: "Yoga Evolution: New Study Reveals Mental Health Benefits"
        """
    ...
    def generate_summary(self, article):
        ...
        prompt = f"""
        Summarize the following yoga article in this format:

        🧘 **[CATCHY TITLE]: [Subtitle]**

        🌟 **Yoga Insight:**
        [1-2 sentences highlighting the key yoga-related information or development]
        ...
        try:
            response = client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "You are a yoga-savvy AI assistant that creates engaging summaries of yoga news for social media and newsletters."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=300,
                n=1,
        ...
        <body>
            ...
            <main class="container">
                <section class="highlights">
                    <h2>Key Yoga Highlights <span class="date">{today_date}</span></h2>
    ...
    def generate_article_html(self, article):
        ...
        for section in sections:
            if section.startswith('🧘'):
                ...
                yoga_insight = section.replace('🌟 **Yoga Insight:**', '').strip()
            elif section.startswith('💡'):
    ...
    def save_html_page(self, html_content, filename="yoga_news_highlights.html"):
            ...
            with psycopg2.connect(self.db_url) as conn:
                with conn.cursor() as cur:
                    insert_query = sql.SQL("""
                        ...
                        RETURNING id
                    """)
                    cur.execute(insert_query, (title, content, 17))  # Assuming 3 is the topic_id for Yoga
...
def main():
    ...
    keywords = [
        'yoga practice', 'yoga benefits', 'yoga research', 'yoga lifestyle', 'yoga techniques',
        'meditation', 'mindfulness', 'yoga therapy', 'yoga for health', 'yoga philosophy',
        'yoga asanas', 'pranayama', 'yoga teacher training', 'yoga retreats', 'yoga workshops',
        'yoga anatomy', 'yoga alignment', 'yoga for stress relief', 'yoga for flexibility',
        'yoga for strength', 'yoga and mental health', 'yoga and spirituality'
    ]

    logger.info(f"Fetching top yoga-related news articles for {yesterday}...")
    ...
    logger.info("Yoga news fetching, summarization, HTML generation, and database storage complete.")
