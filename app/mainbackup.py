    ...
    try:
        app.add_middleware(
            ...
            allow_origins=[
                ...
                "https://www.thecuriodaily.com"  # Add this line
            ],
...
async def add_security_headers(request: Request, call_next):
    response = await call_next(request)
    response.headers["Content-Security-Policy"] = "default-src 'self' https://thecuriodaily.com https://www.thecuriodaily.com; upgrade-insecure-requests"
    return response
