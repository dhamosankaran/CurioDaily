...
def main():
    ...
    logger.info(f"Fetching top 10 psychology-related news articles for {yesterday}...")
    ...
    if articles:
        ...
        if html_content:
            ...
            inserted_id = fetcher.store_newsletter(dynamic_title, html_content, 21, subscription_ids)  # Topic ID 21 for Psychology
            if inserted_id:
    ...
    logger.info("Psychology news fetching, summarization, and newsletter generation complete.")
