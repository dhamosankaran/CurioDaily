...
def main():
    ...
    logger.info(f"Fetching top 10 space-related news articles for {yesterday}...")
    ...
    if articles:
        ...
        if html_content:
            ...
            inserted_id = fetcher.store_newsletter(dynamic_title, html_content, 20, subscription_ids)  # Using topic_id 20 for Space
            if inserted_id:
    ...
    logger.info("Space news fetching, summarization, and newsletter generation complete.")
