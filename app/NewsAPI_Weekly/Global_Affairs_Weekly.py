...
class GlobalAffairsWeeklyFetcher:
    def __init__(self):
        ...
        self.trusted_sources = [
            'reuters.com', 'apnews.com', 'nytimes.com/world', 'bbc.com/news/world',
            'theguardian.com/world', 'foreignpolicy.com', 'economist.com',
            'aljazeera.com', 'france24.com', 'dw.com', 'cfr.org',
            'brookings.edu', 'ft.com/world', 'project-syndicate.org',
            'worldpoliticsreview.com', 'foreignaffairs.com'
        ]

        self.international_organizations = [
            'United Nations', 'NATO', 'European Union', 'World Bank', 'IMF',
            'WHO', 'WTO', 'ICC', 'ASEAN', 'African Union', 'UNHCR',
            'UNICEF', 'UNESCO', 'IAEA', 'G7', 'G20', 'OECD', 'OPEC'
        ]

        self.priority_topics = [
            'International Relations', 'Diplomacy', 'Global Security',
            'Climate Change', 'Human Rights', 'Trade Relations',
            'Political Crisis', 'Peace Negotiations', 'Global Economy',
            'Humanitarian Issues', 'Migration', 'Energy Policy',
            'International Law', 'Democracy', 'Global Development'
        ]
    ...
    async def fetch_news(self, start_date: datetime, end_date: datetime) -> List[Dict[str, Any]]:
        ...
        queries = [
            ...
            'global security OR international conflict',
            'climate change OR global environment',
            'human rights OR humanitarian crisis',
            'international trade OR global economy',
            'United Nations OR international organizations',
            'global development OR international aid'
        ]
    ...
    async def process_articles_with_ai(self, articles: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            messages = [
                {"role": "system", "content": """Global affairs news curator. Output JSON:
{
  "filtered_indices": [0-based indices],
  "highlights": [{"text": "max 170 chars", "category": "cat", "icon": "globe", "color": "#hex"}],
  "title": "Global Affairs: [Theme]",
  "summary": "2-line international affairs summary"
}"""},
                {"role": "user", "content": f"Select top global affairs news:\n{articles_text}"}
            ]
    ...
    def _get_empty_response(self) -> Dict[str, Any]:
        return {
            'filtered_articles': [],
            'highlights': [],
            'title': "This Week in Global Affairs",
    ...
    def _process_ai_response(self, response: Any, articles: List[Dict[str, Any]]) -> Dict[str, Any]:
        try:
            ...
            return {
                ...
                'title': str(result.get('title', "This Week in Global Affairs")),
                'summary': str(result.get('summary', "Latest international developments."))
            }
        except Exception as e:
    ...
    def _fallback_processing(self, articles: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            'highlights': highlights,
            'title': "This Week in Global Affairs",
            'summary': "Latest developments in international relations and global politics."
        }
            ...
            with psycopg2.connect(self.db_url) as conn:
                with conn.cursor() as cur:
                    ...
                    """, (
                        title,
                        content,
                        6,  # Global Affairs Weekly topic ID
...
async def main():
    try:
        fetcher = GlobalAffairsWeeklyFetcher()
        end_date = datetime.now()
        start_date = end_date - timedelta(days=7)
        
        logger.info(f"Fetching global affairs news for {start_date.date()} to {end_date.date()}")
        ...
        if html_content:
            #filename = f"Global_Affairs_Weekly_{end_date.strftime('%Y%m%d')}.html"
